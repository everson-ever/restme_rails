...
RSpec.describe RestmeRails::Core::Scope::Filter::Types::BiggerThanFilterable do
  ...
  describe "#filter" do
    ...
    context "when filtering by quantity" do
      let(:filter_serialized) { { quantity: 5 } }
    ...
    context "when filtering by multiple fields" do
      let(:filter_serialized) { { quantity: 5, establishment_id: 1 } }
