    ...
    module Rules
      ...
      def restme_update(restme_update_custom_params: {})
        @restme_update ||= begin
          ...
          restme_update_instance.assign_attributes(controller_params)
      ...
      def restme_update_set_current_user
        ...
        restme_update_instance.current_user = restme_current_user
      end
      ...
      def restme_update_instance
        @restme_update_instance ||= begin
          ...
          if record
            merged_params = controller_params
            merged_params = merged_params.merge(@restme_update_custom_params) if @restme_update_custom_params.present?

            record.assign_attributes(merged_params)
            record
          end
        end
      end
      ...
      def restme_update_not_found_error
        {
          errors: "Not found object to id: #{params[:id]}"
        }
      end
      ...
      def restme_update_current_action
        ...
        restme_update_controller_current_action.presence_in(
      ...
      #
      # @return [Symbol]
      def restme_update_controller_current_action
        action_name.to_sym
      end
      ...
      def restme_update_rules_class
        @restme_update_rules_class ||=
          "#{klass.name}Rules::Update::Rules"
          .safe_constantize
      end
    end
  end
